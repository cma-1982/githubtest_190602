...
bool R_PG_Timer_Set_MTU_U0_C2(void)
{
	...
	parameters.TGR_A_B_operation = PDL_MTU2_A_IC_RISING_EDGE | PDL_MTU2_B_IC_RISING_EDGE;
	parameters.TGRA_TCNTV_value = 0;
	parameters.TGRB_TCNTW_value = 65535;

	res = R_MTU2_Set(
		2,
		PDL_MTU2_PIN_2A_PB5 | PDL_MTU2_PIN_2B_PE5,
		PDL_MTU2_PIN_CLKC_P22 | PDL_MTU2_PIN_CLKD_P23
	);
