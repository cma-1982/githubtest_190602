...
bool R_PG_SCI_Set_C2(void)
{
	...
	res = R_SCI_Set(
		2,
		PDL_SCI_PIN_SCI2_SCK2_P51 | PDL_SCI_PIN_SCI2_SMISO2_P12 | PDL_SCI_PIN_SCI2_SMOSI2_P13
	);
	...
	return R_SCI_Create(
		2,
		PDL_SCI_SYNC | PDL_SCI_TX_CONNECTED | PDL_SCI_RX_CONNECTED | PDL_SCI_SPI_MODE | PDL_SCI_MSB_FIRST | PDL_SCI_INVERSION_OFF | PDL_SCI_CLK_INT_OUT | PDL_SCI_SPI_SS_DISABLE | PDL_SCI_CLOCK_PHASE_DELAYED,
		BIT_31 | PDL_SCI_PCLK_DIV_1 | 23 | (500000 & 0x00FFFF00ul),
		0,
		0
	);
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_SPIMode_Transfer_C2(uint8_t * tx_start, uint8_t * rx_start, uint16_t count)
*
* Function Name: R_PG_SCI_SPIMode_Transfer_C2
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_SPIMode_GetErrorFlag_C2(bool * overrun)
*
* Function Name: R_PG_SCI_SPIMode_GetErrorFlag_C2
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_ClearReceptionErrorFlag_C2(void)
*
* Function Name: R_PG_SCI_ClearReceptionErrorFlag_C2
*
