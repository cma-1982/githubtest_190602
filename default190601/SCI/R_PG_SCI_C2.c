...
bool R_PG_SCI_Set_C2(void)
{
	...
	return R_SCI_Create(
		2,
		PDL_SCI_SYNC | PDL_SCI_TX_CONNECTED | PDL_SCI_RX_CONNECTED | PDL_SCI_SPI_MODE | PDL_SCI_LSB_FIRST | PDL_SCI_INVERSION_OFF | PDL_SCI_CLK_INT_OUT | PDL_SCI_SPI_SS_DISABLE,
		BIT_31 | PDL_SCI_PCLK_DIV_1 | 119 | (100000 & 0x00FFFF00ul),
		0,
		0
	);
