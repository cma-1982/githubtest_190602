...
* Limitations  : 
******************************************************************************
* History : 24.07.2019 Version Description
*         :   
******************************************************************************/
...
bool R_PG_SCI_Set_C0(void)
{
	...
	res = R_SCI_Set(
		0,
		PDL_SCI_PIN_SCI0_SSCL0_P33 | PDL_SCI_PIN_SCI0_SSDA0_P32
	);
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_Send_C0(bool addr_10bit, uint16_t slave, uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_I2CMode_Send_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_SendWithoutStop_C0(bool addr_10bit, uint16_t slave, uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_I2CMode_SendWithoutStop_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_GenerateStopCondition_C0(void)
*
* Function Name: R_PG_SCI_I2CMode_GenerateStopCondition_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_Receive_C0(bool addr_10bit, uint16_t slave, uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_I2CMode_Receive_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_RestartReceive_C0(bool addr_10bit, uint16_t slave, uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_I2CMode_RestartReceive_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_GetEvent_C0(bool * nack)
*
* Function Name: R_PG_SCI_I2CMode_GetEvent_C0
*
