...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Set_PA3(void)
*
* Function Name: R_PG_IO_PORT_Set_PA3
*
* Description  : I/Oポート(1端子)の設定
*
* Arguments    : なし
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Set_PA7(void)
*
* Function Name: R_PG_IO_PORT_Set_PA7
*
* Description  : I/Oポート(1端子)の設定
*
* Arguments    : なし
