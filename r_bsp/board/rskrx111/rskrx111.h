...
/* RSPI I/O pins definitions */
#define RSPI_CHANNEL_0      0
#define SDMICRO_CS          PORTA.PODR.BIT.B4
#define RSPI_SCLOCK         PORTB.PODR.BIT.B0
#define RSPI_MOSI           PORTA.PODR.BIT.B6
#define RSPI_MISO           PORTA.PODR.BIT.B3
